        ...
        <div className="relative z-10 flex flex-col items-center gap-6 w-full max-w-2xl">
          ...
          <div className="banner mt-6">
            <img
              src={banner}
              alt="banner"
              className="w-64 md:w-96 lg:w-[500px] animate-fadeIn"
            />
          </div>

          <Link
            to="/home"
            className="mt-6 mb-12 bg-primary text-black font-bold px-6 py-3 rounded-xl flex items-center justify-center gap-2 hover:scale-105 transition-transform"
          >
